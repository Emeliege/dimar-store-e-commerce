...
const TopSellers = () => {
  ...
  return (
    <div className="bg-white w-[5.5rem] text-[7px] mt-[6.4rem] 2xl:w-[18rem] 2xl:h-[49rem] xl:w-[15rem] xl:h-[49rem] xl:mt-[7.5rem] border lg:h-[44rem] lg:w-[13.5rem] md:w-[10rem] md:mr-[-7px] md:p-3 sm:text-[12px] sm:mt-[7.6rem] sm:w-[10rem] sm:mr-[-5rem] sm:p-2 rounded dark:bg-neutral-900 dark:text-neutral-300">
        ...
        {authors.map((author, index) => (
          ...
          >
            <section className="flex justify-center items-center">
              <img
                src={author.image}
                className="w-[25%] h-[25%] justify-center rounded-full md:mr-[2px] ml-2"
                alt={author.name}
              />
            ...
            <button
              ...
              className={` rounded px-1 py-1 md:px-1 md:py-[3px] sm:px-1 sm:py-[3px] sm:ml-4 ${
                author.isFollowing
